          ...
          <table class="table datatable">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td><a class="mx-2" href="user-edit.php?id=<?=$row['id']?>"><i class="bi bi-pencil-square" style="color:blue"></i></a><a href="user-delete.php?id=<?=$row['id']?>"><i class="bi bi-trash" style="color:red"></i></a></td>
                <td></td>
               </tr>
               <?php
                    }
